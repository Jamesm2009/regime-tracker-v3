...
const payload = {
from: ‘Macro Regime Tracker [alerts@yourdomain.com](mailto:alerts@yourdomain.com)’, // ← update with your Resend verified domain
to: subscribers,
...
await redisSet('regime:history', JSON.stringify(history));
